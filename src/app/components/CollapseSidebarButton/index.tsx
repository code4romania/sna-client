  ...
  return (
    <div onClick={props.openMenu} className={style.collapseExpandContainer}>
      ...
      <svg className={style.collapseExpandContainerIcon} width='16' height='17' viewBox='0 0 16 17'>
        ...
        <g fill="#A5B3BB" fill-rule="evenodd" transform={svgRotate}>
          <path d="M0 0h2v17H0z"/>
          <path d="M7.414 8l2.293-2.293c.39-.39.39-1.024 0-1.414-.39-.39-1.024-.39-1.414 0L3.586 9l4.707 4.707c.39.39 1.024.39 1.414 0 .39-.39.39-1.024 0-1.414L7.414 10H14.5c.552 0 1-.448 1-1s-.448-1-1-1H7.414z" fill-rule="nonzero"/>
        </g>
      </svg>
    </div>
  );
